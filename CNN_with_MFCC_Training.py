...
def load_data(args, batch_size=64):
    dataset = pickle.load(open('/home/achharia/Domain-adaptation/domain_adaptation_old/LSTM-DENSE/speech-emotion-recognition-iemocap/preprocess_info/feature_vectors.pkl','rb'))

    #dataset = pickle.load(open('/home/achharia/Domain-adaptation/domain_adaptation/NSC_part5_labelled_emotion/Preprocessed_files/hopefeature.pkl','rb'))
...
class CNN(torch.nn.Module):
    ...
    def __init__(self):
        ...
        # Affine Layer
        self.fc2 = torch.nn.Linear(384, 50, bias=True)  #384 earlier
...
#)
    ...
    #model.load_state_dict(torch.load('/home/achharia/Domain-adaptation/domain_adaptation/LSTM-DENSE/speech-emotion-recognition-iemocap/code/models/dl_models_using_spectrogram/best_model_session.pt'))
    ...
    for epoch in range(1, n_epoch):    
        ...
        if test_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), 'best_model_session_chharia.pt')
            print("Saved . . .")
