...
def load_data(args, config):
    ...
    num_train = int(len(dataset['label']) * 0.8)
...
def main(args):
    ...
    #             torch.nn.Dropout(p=1 - keep_prob))
            ...
            self.fcd = torch.nn.Linear(50, 50, bias=True)
    ...
    #Diag_Affine_layer=torch.load('diag_affine_weights.pth')
...
#    for i, (inputs, labels,filename) in enumerate(valloader):
    ...
    for epoch in range(1, n_epoch):    
        ...
        if test_acc > best_val_acc:
            ...
            torch.save(model.fcd.state_dict(), 'fcd_weights.pth')
